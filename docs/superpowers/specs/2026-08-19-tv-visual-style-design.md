...
- **动画(2026-08-19 修订,需求方确认)**:**不做整行翻入**——标题挂载即静止呈现目标字母;唯一动画为**偶发翻动**:每 6–10 秒随机取 1–2 块牌,慢速翻 2–3 次(每次翻转 ~220–280ms,机械慢节奏)后停回原字母;setInterval 卸载清理。
- **样式对齐参考图**:每字母独立近黑牌面(上半略亮的纵向渐变)、牌间窄缝、中央拆分线清晰、白色粗体紧凑字母、轻微内嵌质感。
